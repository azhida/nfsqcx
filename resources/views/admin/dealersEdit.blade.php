    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            <label for="dealers_name" class="layui-form-label">
                <span class="x-red">*</span>经销商名称
            </label>
            <div class="layui-input-inline">
                <input type="text" id="dealers_name" name="dealers_name" required="" lay-verify="required"
                       autocomplete="off" class="layui-input" value="{{ $info->dealers_name ?? '' }}">
            </div>
        </div>
