...
<div class="x-body">
  ...
  <xblock>
    ...
    <button class="layui-btn" onclick="x_admin_show('添加用户','{{ url('admin/dealersAdd') }}')"><i class="layui-icon"></i>添加</button>
  ...
  <table class="layui-table">
    ...
    @foreach($list as $value)
      <tr>
        ...
        <td class="td-manage">
          <a title="编辑"  onclick="x_admin_show('编辑','{{ url('admin/dealersEdit') . '/' . $value->id }}')" href="javascript:;">
