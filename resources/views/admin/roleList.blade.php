...
<div class="x-body">
  <div class="layui-row">
    <form class="layui-form layui-col-md12 x-so" id="search_form">
      ...
      <input type="text" name="role_name"  placeholder="请输入角色名" autocomplete="off" class="layui-input" value="{{ $search_params['role_name'] ?? '' }}">
  ...
  <xblock>
    ...
    <button class="layui-btn" onclick="x_admin_show('添加用户','{{ url('admin/roleAdd') }}')"><i class="layui-icon"></i>添加</button>
  ...
  <table class="layui-table">
    ...
    @foreach($list as $value)
      <tr>
        ...
        <td class="td-manage">
          <a title="编辑"  onclick="x_admin_show('编辑','{{ url('admin/roleEdit') . '/' . $value->id }}')" href="javascript:;">
