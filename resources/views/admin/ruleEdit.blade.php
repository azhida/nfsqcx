    ...
    <form class="layui-form">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="rule_name" name="rule_name" required="" lay-verify="required|rule_name"
                       autocomplete="off" class="layui-input" value="{{ $info->rule_name }}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="real_name" name="route_name" required=""
                       autocomplete="off" class="layui-input" value="{{ $info->route_name }}">
            </div>
        </div>
            ...
            <div class="layui-input-inline">
                <select name="parent_id">
                    ...
                    @foreach($list as $value)
                        <option value="{{ $value->id }}" @if($value->id == $info->parent_id) selected="selected" @endif>{{ $value->rule_name ?? '' }}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea placeholder="请输入内容" id="desc" name="rule_desc" class="layui-textarea">{{ $info->rule_desc ?? '' }}</textarea>
            </div>
        </div>
        <div class="layui-form-item">
