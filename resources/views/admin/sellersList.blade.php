...
<div class="x-body">
  <div class="layui-row">
    <form class="layui-form layui-col-md12 x-so" id="search_form">
      ...
      <input type="text" name="account"  placeholder="请输入登录账户" autocomplete="off" class="layui-input" value="{{ $search_params['account'] ?? '' }}">
  ...
  <table class="layui-table">
    ...
    @foreach($list as $value)
      <tr>
        ...
        <td class="td-manage">
          <a title="编辑"  onclick="x_admin_show('编辑','{{ url('admin/sellersEdit') . '/' . $value->id }}')" href="javascript:;">
